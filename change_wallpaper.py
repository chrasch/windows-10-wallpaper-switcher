...
#Threading some functions for better performance
merge_thread = threading.Thread(target = merge_images)

win_api_thread = threading.Thread(target = change_wallpaper)
win_api_thread.setDaemon(True)


random_images()
merge_thread.start()
win_api_thread.start()
